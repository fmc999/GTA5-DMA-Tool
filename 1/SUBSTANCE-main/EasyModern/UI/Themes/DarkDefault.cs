...
{
    internal class DarkDefault : ITheme
    {
        public string ID { get; set; } = "theme.darkdefault";
        ...
        public bool Apply()
        {
            ...
            style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.239215686917305f, 0.5176470875740051f, 0.8784313797950745f, 1.0f);
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.2588235437870026f, 0.5882353186607361f, 0.9764705896377563f, 1.0f);
