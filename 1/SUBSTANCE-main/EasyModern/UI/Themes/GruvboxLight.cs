...
{
    internal class GruvboxLight : ITheme
    {
        public string ID { get; set; } = "theme.gruvbox-light";
        ...
        public bool Apply()
        {
            ...
            // ----------------------------
            // Background (bg)
            Vector4 bg0 = new Vector4(0.984f, 0.945f, 0.78f, 1.00f);  // #fbf1c7
            Vector4 bg1 = new Vector4(0.92f, 0.86f, 0.70f, 1.00f);    // #ebdbb2
            Vector4 bg2 = new Vector4(0.84f, 0.77f, 0.63f, 1.00f);    // #d5c4a1
            Vector4 bg3 = new Vector4(0.74f, 0.68f, 0.57f, 1.00f);    // #bdae93

            // Foreground / Texto (fg)
            Vector4 fg0 = new Vector4(0.235f, 0.219f, 0.214f, 1.00f); // #3c3836
            Vector4 fg1 = new Vector4(0.19f, 0.19f, 0.19f, 1.00f);    // ~ #303030 (similar)
            Vector4 fg2 = new Vector4(0.31f, 0.28f, 0.27f, 1.00f);    // ~ #504945 (más oscuro)
            Vector4 fg3 = new Vector4(0.16f, 0.16f, 0.16f, 1.00f);    // #282828

            // Colores "brillantes" (Aurora) - mismos que en Gruvbox Dark
            ...
            colors[(int)ImGuiCol.FrameBgActive] = bg2;
            ...
            colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.85f, 0.80f, 0.70f, 0.2f);
