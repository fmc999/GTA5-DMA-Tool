...
{
    internal class Comfy : ITheme
    {
        public string ID { get; set; } = "theme.comfy";
        ...
        public bool Apply()
        {
            ...
            if (!Core.Instances.Settings.RGB_Color) style.Colors[(int)ImGuiCol.Border] = new Vector4(0.4235294163227081f, 0.3803921639919281f, 0.572549045085907f, 0.54935622215271f);
