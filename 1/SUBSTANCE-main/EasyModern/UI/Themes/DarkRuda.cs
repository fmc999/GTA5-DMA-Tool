...
{
    internal class DarkRuda : ITheme
    {
        public string ID { get; set; } = "theme.darkruda";
        ...
        public bool Apply()
        {
            ...
            if (!Core.Instances.Settings.RGB_Color) style.Colors[(int)ImGuiCol.Border] = new Vector4(0.0784313753247261f, 0.09803921729326248f, 0.1176470592617989f, 1.0f);
