...
{
    internal class RedDark : ITheme
    {
        public string ID { get; set; } = "theme.reddark";
        ...
        public bool Apply()
        {
            ...
            style.Colors[(int)ImGuiCol.Text] = new Vector4(0.7490196228027344f, 0.7490196228027344f, 0.7490196228027344f, 1.0f);
            style.Colors[(int)ImGuiCol.TextDisabled] = new Vector4(0.3490196168422699f, 0.3490196168422699f, 0.3490196168422699f, 1.0f);
            style.Colors[(int)ImGuiCol.WindowBg] = new Vector4(0.0f, 0.0f, 0.0f, 0.9399999976158142f);
            ...
            if (!Core.Instances.Settings.RGB_Color) style.Colors[(int)ImGuiCol.Border] = new Vector4(0.0f, 0.0f, 0.0f, 0.5f);
            ...
            style.Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.3686274588108063f, 0.1372549086809158f, 0.1372549086809158f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.3882353007793427f, 0.2000000029802322f, 0.2000000029802322f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.TitleBg] = new Vector4(0.03921568766236305f, 0.03921568766236305f, 0.03921568766236305f, 1.0f);
            style.Colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.47843137383461f, 0.1568627506494522f, 0.1568627506494522f, 1.0f);
            style.Colors[(int)ImGuiCol.TitleBgCollapsed] = new Vector4(0.47843137383461f, 0.1568627506494522f, 0.1568627506494522f, 1.0f);
            ...
            style.Colors[(int)ImGuiCol.CheckMark] = new Vector4(0.5568627715110779f, 0.09803921729326248f, 0.09803921729326248f, 1.0f);
            style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(1.0f, 0.1882352977991104f, 0.1882352977991104f, 0.4000000059604645f);
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.886274516582489f, 0.0f, 0.1882352977991104f, 1.0f);
            style.Colors[(int)ImGuiCol.Button] = new Vector4(1.0f, 0.1882352977991104f, 0.1882352977991104f, 0.4000000059604645f);
            style.Colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.800000011920929f, 0.168627455830574f, 0.0f, 1.0f);
            style.Colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.886274516582489f, 0.0f, 0.1882352977991104f, 1.0f);
            style.Colors[(int)ImGuiCol.Header] = new Vector4(0.3294117748737335f, 0.3490196168422699f, 0.3568627536296844f, 0.5299999713897705f);
            style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.7568627595901489f, 0.2784313857555389f, 0.4392156898975372f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.4666666686534882f, 0.4666666686534882f, 0.4666666686534882f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.Separator] = new Vector4(0.3176470696926117f, 0.3176470696926117f, 0.3176470696926117f, 1.0f);
            style.Colors[(int)ImGuiCol.SeparatorHovered] = new Vector4(0.3176470696926117f, 0.3176470696926117f, 0.3176470696926117f, 1.0f);
            style.Colors[(int)ImGuiCol.SeparatorActive] = new Vector4(0.3176470696926117f, 0.3176470696926117f, 0.3176470696926117f, 1.0f);
            ...
            style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.06666667014360428f, 0.06666667014360428f, 0.06666667014360428f, 0.5099999904632568f);
            style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.8588235378265381f, 0.2274509817361832f, 0.4274509847164154f, 0.6700000166893005f);
            ...
            style.Colors[(int)ImGuiCol.TableRowBgAlt] = new Vector4(1.0f, 1.0f, 1.0f, 0.07000000029802322f);
