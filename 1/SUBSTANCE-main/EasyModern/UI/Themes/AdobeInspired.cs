...
{
    internal class AdobeInspired : ITheme
    {
        public string ID { get; set; } = "theme.adobekinspired";
        ...
        public bool Apply()
        {
            ...
            if (!Core.Instances.Settings.RGB_Color) style.Colors[(int)ImGuiCol.Border] = new Vector4(1.0f, 1.0f, 1.0f, 0.1630901098251343f);
